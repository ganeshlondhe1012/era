...
class MemoryController extends ChangeNotifier {
  MemoryController()
    : _service = MemoryService(repository: LocalMemoryRepository());
  ...
  Future<void> remember({required String key, required String value}) async {
    await _service.addMemory(key: key, value: value);
