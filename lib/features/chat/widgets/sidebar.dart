...
import '../../rag/screens/ask_document_screen.dart';
...
class Sidebar extends StatelessWidget {
  ...
  Widget _buildNewChatButton(ChatController controller) {
    return Padding(
  ...
  Widget _buildSearch(BuildContext context, ChatController controller) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          ChatSearchBar(onChanged: controller.searchChats),
        ],
      ),
    );
  }
            ...
            return Column(
              children: [
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        subtitle: const Text('Local RAG library'),
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                      ...
                      ListTile(
                        ...
                        title: const Text('Ask Documents'),
                        subtitle: const Text('Query imported files'),
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => const AskDocumentsScreen(),
                            ),
                          );
                        },
                      ),
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final actualIndex = controller.chats.indexOf(chat);

                      return ChatTile(
                        chat: chat,
                        selected: controller.currentChatIndex == actualIndex,
                        onTap: () {
                          ...
                          switch (action) {
                            case ChatMenuAction.rename:
                              final title = await showDialog<String>(
                                context: context,
                                builder: (_) =>
                                    RenameChatDialog(initialTitle: chat.title),
                              );

                              if (title != null && title.trim().isNotEmpty) {
                                controller.switchChat(actualIndex);

                                await controller.renameCurrentChat(title);
                              }
                              break;
                            ...
                            case ChatMenuAction.delete:
                              final confirmed = await showDialog<bool>(
                                context: context,
                                builder: (_) => const DeleteChatDialog(),
                              );
                ...
                ListTile(
                  ...
                  subtitle: const Text('Era v1.2.0'),
                  onTap: () {
                    Navigator.push(
                      context,
