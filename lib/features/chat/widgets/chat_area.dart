...
class _ChatAreaState extends State<ChatArea> {
  final ChatScrollController _scroll = ChatScrollController();
      ...
      child: Consumer<ChatController>(
        builder: (context, controller, _) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            ...
            _scroll.scrollToBottom(animated: controller.messages.length > 1);
          });
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const _WelcomeItem(
                              ...
                              text: 'Upload PDF, DOCX or TXT files',
                            ),
                ...
                itemBuilder: (context, index) {
                  return Align(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: MessageBubble(message: controller.messages[index]),
                    ),
                  );
                },
              ),
...
class _WelcomeItem extends StatelessWidget {
  const _WelcomeItem({required this.icon, required this.text});
